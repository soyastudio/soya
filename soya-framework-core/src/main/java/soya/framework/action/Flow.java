...
public class Flow {
    ...
    public static class Task {
        ...
        public static TaskBuilder builder(Class<? extends ActionCallable> commandType) {
    ...
    public static class FlowBuilder {
        ...
        public Class<? extends ActionCallable> getCommandType(String uri) {
            return ActionContext.getInstance().getActionType(ActionName.fromURI(uri));
        }
    ...
    public static class TaskBuilder {
        private Class<? extends ActionCallable> commandType;
        private Configuration configuration;
        private Compiler compiler;
        private Callback callback;

        private TaskBuilder(Class<? extends ActionCallable> commandType) {
    ...
    static class DefaultConfiguration implements Configuration {
        ...
        DefaultConfiguration(Class<? extends ActionCallable> commandType) {
            this.commandType = commandType;
            Command command = commandType.getAnnotation(Command.class);
            this.command = command.name();
            this.name = command.name();
            this.options = ActionParser.parse(commandType);
        }
            ...
            if ("properties".equals(type)) {
                ...
                list.forEach(o -> {
                    ...
                    if (je != null) {
                        ...
                        Class<? extends ActionCallable> cls = builder.getCommandType(uri);
                        if (cls == null) {
