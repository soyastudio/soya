...
@Command(group = "kafka", name = "seek-to-end", httpMethod = Command.HttpMethod.GET)
public class SeekToEndAction extends KafkaConsumeAction<KafkaConsumeAction.ConsumerRecordMetadata[]> {
