...
public final class ActionParser {
    ...
    public static Field[] getOptionFields(Class<? extends ActionCallable> cmd) {
    ...
    public static Options parse(Class<? extends ActionCallable> cmd) {
        Command command = cmd.getAnnotation(Command.class);
        if (command == null) {
            throw new IllegalArgumentException("Command is not defined: " + cmd.getName());
        }
    ...
    public static Field getDataInputField(Class<? extends ActionCallable> cmd) {
        Field field = null;
    ...
    public static ActionCallable fromURI(String uri) throws Exception {
        return fromURI(new URI(uri));
    }

    public static ActionCallable fromURI(URI uri) throws Exception {
        return fromURI(uri, null);

    }

    public static ActionCallable fromURI(URI uri, String payload) throws Exception {
        ...
        if ("class".equalsIgnoreCase(uri.getScheme())) {
            ...
            cls = ActionContext.getInstance().getActionType(ActionName.fromURI(uri));
        }
    ...
    public static ActionCallable fromCommandLine(String commandline) throws Exception {
        return fromCommandLine(commandline, null);
    }

    public static ActionCallable fromCommandLine(String commandline, String payload) throws Exception {
        ...
        Field dataInputField = ActionParser.getDataInputField(cls);
        ...
        ActionCallable callable = cls.newInstance();
        for (Field field : fields) {
            CommandOption commandOption = field.getAnnotation(CommandOption.class);
            String value = null;
            if (CommandOption.ParamType.ReferenceParam.equals(commandOption.paramType())) {
                value = ActionContext.getInstance().getProperty(commandOption.referenceKey());
    ...
    public static ActionCallable create(Class<? extends ActionCallable> cls, String[] args) throws Exception {
