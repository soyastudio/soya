package soya.framework.commandline.tasks.document.markdown;
...
public class SoyaCoderMarkdown extends AbstractVisitor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Node document = parser.parseReader(new FileReader(new File(home, "markdown/edis.md")));
        ...
        nt.setText("Enterprise Data Integration System");
        ...
        // Save presentation
        FileOutputStream out = new FileOutputStream(new File(home, "Edis.pptx"));
        ppt.write(out);
        out.close();
