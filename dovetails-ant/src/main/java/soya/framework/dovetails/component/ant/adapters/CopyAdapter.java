...
@AntTaskDef(name = "copy", attributes = {"file", "toFile", "fileSet", "toDir", "includeEmptyDirs", "verbose", "quiet", "overwrite", "force", "flatten"})
public class CopyAdapter extends AntTaskAdapterSupport<Copy> {
    private String file;
    ...
    public CopyAdapter(JsonElement attributes, ProcessContext context) {
        super(attributes, context);
    }

    @Override
    protected void init(Copy task, TaskSession session) {
        if (file != null) {
