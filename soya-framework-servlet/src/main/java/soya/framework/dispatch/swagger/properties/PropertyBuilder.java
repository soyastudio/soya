package soya.framework.dispatch.swagger.properties;

import soya.framework.dispatch.swagger.ArrayModel;
import soya.framework.dispatch.swagger.Model;
import soya.framework.dispatch.swagger.ModelImpl;
import soya.framework.dispatch.swagger.RefModel;
...
public class PropertyBuilder {
    ...
    public enum PropertyId {
        ...
        public <T> T findValue(Map<PropertyId, Object> args) {
            @SuppressWarnings("unchecked") final T value = (T) args.get(this);
            return value;
        }
    }
