...
public class SwaggerBuilder {
    ...
    public static Swagger create(CommandExecutionContext context) {
        ...
        for (String group : groups) {
            context.getCommands(group).forEach(e -> {
                buildPath(context.getCommandType(e), context, builder);
            });
        }
    ...
    private static void buildPath(Class<? extends CommandCallable> cls, CommandExecutionContext context, Swagger.SwaggerBuilder builder) {
