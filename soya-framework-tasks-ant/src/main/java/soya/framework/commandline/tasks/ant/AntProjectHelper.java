...
public class AntProjectHelper extends ProjectHelper {
    ...
    public static class MainHandler extends AntHandler {
        ...
        public AntHandler onStartChild(String uri, String name, String qname, Attributes attrs,
            ...
            if ("project".equals(name)
                    && (uri.isEmpty() || uri.equals(ProjectHelper.ANT_CORE_URI))) {
                return AntProjectHelper.projectHandler;
            }
            if (name.equals(qname)) {
                throw new SAXParseException("Unexpected element \"{" + uri
                        + "}" + name + "\" {" + ProjectHelper.ANT_CORE_URI + "}" + name, context.getLocator());
            }
    ...
    public static class ProjectHandler extends AntHandler {
                    ...
                    case "name":
                        if (value != null) {
                            ...
                            if (!context.isIgnoringProjectTag()) {
                                ...
                                if (!value.isEmpty() && ProjectHelper.getCurrentTargetPrefix() != null
                                        && ProjectHelper.getCurrentTargetPrefix().endsWith(ProjectHelper.USE_PROJECT_NAME_AS_TARGET_PREFIX)) {
        ...
        public AntHandler onStartChild(String uri, String name, String qname, Attributes attrs,
            ...
            return ("target".equals(name) || "extension-point".equals(name))
                    && (uri.isEmpty() || uri.equals(ProjectHelper.ANT_CORE_URI))
                    ? AntProjectHelper.targetHandler : AntProjectHelper.elementHandler;
        }
    }
    ...
    public static class TargetHandler extends AntHandler {
        ...
        public void onStartElement(String uri, String tag, String qname, Attributes attrs,
            ...
            boolean isInIncludeMode =
                    context.isIgnoringProjectTag() && ProjectHelper.isInIncludeMode();
        ...
        public AntHandler onStartChild(String uri, String name, String qname, Attributes attrs,
                                       AntXMLContext context) throws SAXParseException {
            return AntProjectHelper.elementHandler;
        }
    ...
    public static class ElementHandler extends AntHandler {
        ...
        public void onStartElement(String uri, String tag, String qname, Attributes attrs,
            ...
            for (int i = 0; i < attrs.getLength(); i++) {
                ...
                if (ProjectHelper.ANT_TYPE.equals(name)
                        || (ProjectHelper.ANT_CORE_URI.equals(attrUri)
                        && ProjectHelper.ANT_TYPE.equals(attrs.getLocalName(i)))) {
