...
public class TaskBuildTask extends ReflectionTask<String> {
    ...
    protected String execute() throws Exception {
        Class<? extends TaskCallable> cls = TaskExecutionContext.getInstance().getTaskType(TaskName.fromURI(new URI(uri)));
