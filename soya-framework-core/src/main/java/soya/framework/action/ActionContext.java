...
public abstract class ActionContext {
    ...
    public List<ActionName> getCommands() {
        List<ActionName> list = new ArrayList<>(commands.keySet());
        Collections.sort(list);
        return list;
    }
    ...
    public Class<? extends ActionCallable> getActionType(ActionName actionName) {
    ...
    static class DefaultExecutionContext extends ActionContext implements ServiceLocator, ExecutionContextHandler {
        ...
        public String[] getRequiredProperties() {
            ...
            commands.values().forEach(e -> {
                Field[] fields = ActionParser.getOptionFields(e);
    ...
    static class SpringApplicationContextWrapper implements ActionContext.ServiceLocator {
