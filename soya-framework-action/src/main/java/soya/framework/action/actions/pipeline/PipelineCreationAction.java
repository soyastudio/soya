...
@Command(group = "reflect", name = "pipeline-create", httpMethod = Command.HttpMethod.POST, httpResponseTypes = {Command.MediaType.TEXT_PLAIN})
public class PipelineCreationAction extends ReflectionAction<String> {
