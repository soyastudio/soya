package soya.framework.commandline.tasks.javacodegen.rest;
...
import soya.framework.commandline.tasks.javacodegen.JavaCodeBuilderTask;

import java.lang.reflect.Field;
import java.util.*;

//@Command(group = "soya-rest", name = "api")
public class RestApiGenerator extends JavaCodeBuilderTask {
    ...
    protected void printBody(CodeBuilder builder) {
        ...
        subTypes.forEach(c -> {
            ...
            if (command.group().equals(group)) {
                printCommandMethod((Class<? extends TaskCallable>) c, builder);
            }
        });
    }

    private void printCommandMethod(Class<? extends TaskCallable> cls, CodeBuilder builder) {
